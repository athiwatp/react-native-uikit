    ...
    return (
      <View style={[ styles.row, style ]}>
        <TouchableOpacity onPress={onPress}>
          <Image source={{uri: images[0]}} style={[ styles.full, imageStyle ]}/>
        </TouchableOpacity>
        <View style={styles.lowerSection}>
          <TouchableOpacity onPress={onPress}>
            <Image source={{uri: images[1]}} style={[ styles.half, imageStyle ]}/>
          </TouchableOpacity>
          <TouchableOpacity onPress={onPress}>
            <Image source={{uri: images[2]}} style={[ styles.half, imageStyle ]}/>
          </TouchableOpacity>
        </View>
      </View>
    );
  ...
  // column
    ...
    return (
      <View style={[ styles.column, style ]}>
        <TouchableOpacity onPress={onPress}>
          <Image source={{uri: images[0]}} style={[ styles.mainHalf, imageStyle ]}/>
        </TouchableOpacity>
